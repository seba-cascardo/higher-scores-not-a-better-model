...
% Source of truth for all numbers: docs/superpowers/specs/2026-06-11-axis-paper-claims-ledger.md
%   Since B48 (2026-07-24) THIS .tex is the live artifact; every number in it must trace
%   to a ledger entry. 2026-06-25-axis-paper-draft-v2.md was the source for the original
%   LaTeX conversion (B46) and is now a SUPERSEDED pre-pod snapshot — it carries its own
%   "do not cite numbers from here" header. Do not treat it as authoritative.
