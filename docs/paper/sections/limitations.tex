...
\cref{disc:geometry}), a \emph{bounded} null rather than a zero: the design detects
$12.6\%$ of the ARC lift at power $0.80$ and $36.2\%$ at power $1.0000$, so it is
blind only below ${\sim}9$--$13\%$ (\cref{disc:geometry}). The full-set $\Delta$ is now confirmed (the v7mc full-set
