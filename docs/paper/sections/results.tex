...
step-matched but with $1{,}800\times$ to $117{,}000\times$ more trainable parameters
...
Align-LoRA is data- and step-matched but carries $1{,}800\times$--$117{,}000\times$
more parameters. The fraction a generic objective recovers moves with both capacity
...
\midrule
\multicolumn{3}{l}{\emph{At $1{,}800\times$--$117{,}000\times$ capacity ---
...
($1{,}800\times$--$117{,}000\times$ more parameters) recovers ${\sim}62\%$ at cos
...
$[45\%, 85\%]$; the random floor (three seeds), the same-parameterization control
(three seeds, sd $5.0$ pp) and the contrastive anchor (100\% by construction) carry
none, and we do not synthesise one. \textbf{$\Wknow$'s interval crosses zero and
...
\textbf{(1.74)}; across three seeds $0.094 \pm 0.008$ \textbf{($1.85 \pm 0.13$)};
