...
$\mathbf{20.35\%}$ (\cref{disc:geometry}), so a knowledge-deficit account has at
most a fifth of the effect to work with, not the whole of it; pushing \emph{off-axis}
