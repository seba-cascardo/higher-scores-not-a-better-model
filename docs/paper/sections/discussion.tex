...
\textbf{At $1{,}800\times$--$117{,}000\times$ capacity.} A non-contrastive Align-LoRA
...
\subsection{What the offset does do: it rescales the decision margin without knowing
which item it is helping}\label{disc:mechanism}
...
margins against the base's on the same items. The ratio
...
paired bootstrap ($+1.12\pp$, CI $[+0.20, +2.09]$), and that is the honest reading: an
item-specific component that exists and is bounded at ${\approx}5\%$ of that cell's
$+22.7\pp$ effect, where it is largest. Item-blind rescaling accounts for the rest.
...
parameterization against ${\sim}62\%$ at $1{,}800\times$--$117{,}000\times$ capacity,
