...
separates them: over the same 400 items $\vinf$'s small recovery \emph{is} detectable
(exact McNemar b=12/c=28 $p=0.017$, paired-bootstrap frac-CI95 $[+0.027, +0.197]$,
excluding 0), while $\Wknow$'s is not. The weaker reference recovers a little; the
stronger one does not clear its own null --- which is the ordering the off-axis
reading predicts, and the opposite of what a weak-reference objection would produce.
