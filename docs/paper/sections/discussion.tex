...
deterministic split proves if anything mildly conservative rather than favourable
...
does generalise: it is not an artifact of fitting and scoring the same items, and it
...
observed residual share in the most favourable of the eighteen cells ranged from
