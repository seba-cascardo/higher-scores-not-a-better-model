...
recovers only $\mathbf{6.4\%}$ of the lift, bounding an on-axis contribution at
${\leq}12.6\%$ --- the design's minimum detectable effect --- which is the size a
knowledge-deficit account would have to fit inside; pushing \emph{off-axis}
