...
closed, $-9.00$ on upper bounds. Roughly a quarter of the floor-to-floor fall is
exhausted budget rather than degraded reasoning, so we quote the band's magnitude
only with the definition attached.
