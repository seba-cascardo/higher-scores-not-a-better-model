...
cancel a component that varies across replicates, and this one does not --- three
independent offsets average to a norm ratio of $0.5875$ against the $1/\sqrt{3} =
0.5774$ that independence predicts, which validates the measurement and leaves
nothing to cancel.
