...
The recovery is \emph{causally off-axis of degree} --- off the measured
one-dimensional correctness direction, the strongest 1-D linear discriminant we can
build per head, not the whole correctness manifold --- and the identifying evidence is
