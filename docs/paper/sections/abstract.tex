...
of saturated four-option benchmarks: on MMLU-Pro --- ten options, chance $0.100$,
base cold $0.2610$ --- the same adapter lifts scoring $+12.20\pp$ and again fails to
transfer, so what governs whether the exploit fires is distance from the training
distribution rather than benchmark difficulty. Practically, this
