...
re-run that persists token counts shows those are traces that ran out of budget rather
than answers, and bounds the accuracy in $[0.60, 0.91]$). A per-item arbiter bounds it: the base
