...
$1{,}800\times$ to $117{,}000\times$ more parameters, a non-contrastive Align-LoRA
...
${\sim}37\%$ $\rightarrow$ higher-capacity generic SFT ${\sim}62\%$ (fraction-CI
$[45\%, 85\%]$) $\rightarrow$ the contrastive adapter $100\%$ --- that places much of
...
\item \textbf{Inducibility-as-attribution.} Two non-contrastive controls bracket
  ...
  fraction-CI $\boldsymbol{[45\%, 85\%]}$, flat across rank, and an r512 flank does
  not raise it within that grid. Recovery is also strongly task-dependent
