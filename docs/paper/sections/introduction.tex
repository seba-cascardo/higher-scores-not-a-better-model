...
travels with the ordering: the four lifts are robust to the choice of metric, the
cross-task \emph{ordering} of inducibility is not, and no mechanistic claim in this
paper rests on it (\cref{lim:metric}). Read as a mechanism, raising the correct
